...
const bgTaglineComponent = () => {
  // Text animation
  const fullText = 'Kindness in every bite, sharing food, sharing Love.';
    ...
    return (
      // Background image with tagline
        ...
        <Typography variant="h2" sx={{ color: '#fff', textAlign: 'center', }} className="tagline">
          ...
          At KindCrate, we're on a mission to combat hunger and food waste. We rescue excess food from restaurants and events and redistribute it to those in need. Join us in making a difference, one meal at a time.
          </Typography>
