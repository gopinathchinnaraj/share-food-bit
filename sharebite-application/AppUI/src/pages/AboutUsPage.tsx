    ...
    <>
      ...
      <Container>
        ...
        <Typography
          ...
          sx={{ fontSize: "18px" }}
        >
          kindCrate is a non-profit organization dedicated to alleviating hunger
        ...
        <Typography
          ...
          sx={{ fontSize: "18px" }}
        >
          Every meal shared through kindCrate is a step towards a world where no
      ...
      <Container sx={{ mt: 4, mb: 8 }}>
        ...
        <Typography variant="body1" align="justify" paragraph fontSize={18}>
          At KindCrate, our mission is simple yet profound: to alleviate hunger
